...
namespace PhotoSharing.Api.Migrations
{
    ...
    [Migration("20260508054226_ReplaceDeletedWithPerUserHidden")]
    partial class ReplaceDeletedWithPerUserHidden
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoSharing.Api.Entities.HiddenPhoto", b =>
                {
                    b.Property<string>("PhotoId")
                        .HasMaxLength(64)
                        .HasColumnType("char(64)")
            ...
            modelBuilder.Entity("PhotoSharing.Api.Entities.HiddenPhoto", b =>
                {
                    b.HasOne("PhotoSharing.Api.Entities.Photo", "Photo")
                        .WithMany("HiddenPhotos")
                        .HasForeignKey("PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PhotoSharing.Api.Entities.User", "User")
                        .WithMany("HiddenPhotos")
